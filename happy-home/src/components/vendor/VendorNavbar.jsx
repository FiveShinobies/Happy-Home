...
import { Home, LayoutDashboard, Briefcase, History, User, Menu, X } from 'lucide-react';
...
const VendorNavbar = () => {
  ...
  const navItems = [
    ...
    { path: '/vendor-home/vendor-dashboard', label: 'Dashboard', icon: LayoutDashboard },
    { path: '/vendor-home/work', label: 'Work', icon: Briefcase },
  ...
  return (
    <nav style={styles.navbar}>
      <div style={styles.container}>
        <Link to="/vendor-home" style={styles.brand}>
          <span style={styles.brandText}>HappyHome</span>
          <span style={styles.brandSubtext}>Vendor</span>
        </Link>
